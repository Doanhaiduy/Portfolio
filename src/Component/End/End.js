...
function End(props) {
    return (
        <div
            className="flex xl:px-[15%] md:px-[8%] px-[20px] items-center justify-center gap-[20px] gap-y-[40px] py-[80px] dark:text-white bg-white dark:bg-black transition-colors"
            id="the-end"
        >
