                ...
                <div className="flex items-center gap-5 justify-center">
                    <div className="grid 2xl:grid-cols-5 lg:grid-cols-4 grid-cols-3 gap-8 uppercase">
                        ...
                        >
                            ...
                            <span className="text-[22px] dark:text-gray-600 font-medium">Node Js</span>
                        </motion.div>
                        <motion.div
                            variants={fadeIn("up", 0.3)}
                            initial="hidden"
                        ...
                        >
                            ...
                            <span className="text-[22px] dark:text-gray-600 font-medium">Sql server</span>
                        </motion.div>
                        <motion.div
                            variants={fadeIn("up", 0.3)}
                            initial="hidden"
                        ...
                        >
                            ...
                            <span className="text-[22px] dark:text-gray-600 font-medium">Github</span>
                        </motion.div>
                        <motion.div
                            variants={fadeIn("up", 0.3)}
                            initial="hidden"
